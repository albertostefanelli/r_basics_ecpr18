...
Or we can simulate a dice roll, with the use of the `sample()` function. If you are interested in how to build such simulations in R, you can check out *Grolemund, Garrett. Hands-On Programming with R: Write Your Own Functions and Simulations. " O'Reilly Media, Inc.", 2014.*
...
> Use your function on the msleep_df$sleep_rem column  
...
zscore(height[1:5], height) # it works! 
```
